CREATE TABLE public.testhistory (
	...
	CONSTRAINT testhistory_fk FOREIGN KEY (testquestion_id) REFERENCES public.testquestion(testquestion_id) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT testhistory_fk_1 FOREIGN KEY (answer_id) REFERENCES public.answer(answer_id) ON DELETE CASCADE ON UPDATE CASCADE
);
