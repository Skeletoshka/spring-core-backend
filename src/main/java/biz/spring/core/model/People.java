...
public class People {
    ...
    public char getPeopleEmail() {
        return peopleEmail;
    }

    public void setPeopleEmail(char peopleEmail) {
        this.peopleEmail = peopleEmail;
    }
    public char getPeoplePhone() {
        return peoplePhone;
    }

    public void setPeoplePhone(char peoplePhone) {
        this.peoplePhone = peoplePhone;
    }
    public char getPeopleDeleteFlag() {
        return peopleDeleteFlag;
    }

    public void setPeopleDeleteFlag(char peopleDeleteFlag) {
        this.peopleDeleteFlag = peopleDeleteFlag;
    }
